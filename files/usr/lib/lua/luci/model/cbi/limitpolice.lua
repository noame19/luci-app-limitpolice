...
r_dir.description = translate(
    ...
    .. "(where packets from the internet first arrive, e.g. <code>wan</code>, "
    .. "<code>pppoe-wan</code>, <code>eth1</code>).<br/>"
    .. "<b>src</b> caps packets <em>from</em> the device → pair with a LAN-side iface "
    .. "(where packets from the device first arrive, e.g. <code>br-lan</code>, "
    .. "<code>eth0</code>).<br/>"
